...
(function(E){
    ...
    myQuery.prototype.allQ = function(sq,suitObj){
        ...
        selectElementArr = newEleArr;
        return this;
    }
	myQuery.prototype.length = selectElementArr.length;
    /**
     * 把元素包装成my$;
     *
	...
	myQuery.prototype.createEle = function(targName){
		selectElementArr = [];
		var ele = doc.createElement(targName);
		if(ele.nodeType == 1){
			selectElementArr.push(ele);			
		}
		return this;
    ...
    myQuery.prototype.getAtt = function(key){
        var result = null;
        var results = [];
        result = selectElementArr[0].getAttribute(key);
/*        switch(selectElementArr.length){
            case 0: result = null;break;
    ...
    myQuery.prototype.unbind = function(where, type){
        ...
        if (DOMEVENT[type]) {
            ...
            fun && ( ele = doc.querySelector(where),
    ...
    myQuery.prototype.childFtoL = function(){
        var childrens = selectElementArr[0].children;
        selectElementArr[0].appendChild(childrens.item(0));
        return this;
    }

    myQuery.prototype.changeChildNode = function(b,a){
      var childrens = selectElementArr[0].children;
      var aEle = childrens.item(a);
      var bEle = childrens.item(b);
    ...
    myQuery.prototype.appends = function(eleArr){
         each(function(ele){
             for(var key in eleArr){
             ele.appendChild(eleArr[key]);
             }
         })
    ...
    myQuery.prototype.animate = function(moveObj,callback ,time, style, delaytime){
        ...
        _Ans["-webkit-transition-delay"] = delaytime + 'ms';
